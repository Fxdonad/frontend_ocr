    ...
    const handleFileUpload = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `http://103.145.63.232:8081/api/pdf/addImage?fileName=${encodeURIComponent(fileName)}&imagePath=${encodeURIComponent(imagePath)}&x=${x}&y=${y}&width=${width}&height=${height}`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
